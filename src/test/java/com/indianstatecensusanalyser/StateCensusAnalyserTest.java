...
public class StateCensusAnalyserTest {
	...
	@Test
	public void givenStateCsv_WhenLoadedIfIncorrectTypeRaiseException_ShouldReturnException() {
		try {
			stateCensusAnalyser = new StateCensusAnalyser();
			Integer result = stateCensusAnalyser.loadingData("State");
			Assert.assertEquals((Integer)37, result);
	...
	@Test
	public void givenStateCsv_WhenLoadedIfIncorrectDelimiterRaiseException_ShouldReturnException() {
		try {
			stateCensusAnalyser = new StateCensusAnalyser();
			Integer result = stateCensusAnalyser.loadingData("State");
			Assert.assertEquals((Integer)37, result);
	...
	@Test
	public void givenStateCsv_WhenLoadedIfIncorrectHeaderRaiseException_ShouldReturnException() {
		try {
			stateCensusAnalyser = new StateCensusAnalyser();
			Integer result = stateCensusAnalyser.loadingData("State");
			Assert.assertEquals((Integer)37, result);
